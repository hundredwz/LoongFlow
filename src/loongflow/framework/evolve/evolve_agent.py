...
# -*- coding: utf-8 -*-
"""
This module defines the EvolveAgent, which orchestrates an evolutionary
...
from loongflow.framework.evolve.context import Context, EvolveChainConfig
from loongflow.framework.evolve.database.database import EvolveDatabase
from loongflow.framework.evolve.evaluator import Evaluator, LoongFlowEvaluator
from loongflow.framework.evolve.finalizer import LoongFlowFinalizer, Finalizer
from loongflow.framework.evolve.register import (
    EXECUTOR,
    PLANNER,
    SUMMARY,
    Worker,
...
class EvolveAgent(AgentBase):
    ...
    def __init__(
        ...
        if config is None:
            raise ValueError("EvolveChainConfig must be provided for EvolveAgent.")
    ...
    async def interrupt_impl(self):
        ...
        self.logger.info("EvolveAgent interruption process complete.")
